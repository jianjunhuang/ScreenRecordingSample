...
public final class MainActivity extends AppCompatActivity
    ...
    private DesEditText mWidthEditText;
    private DesEditText mHeightEditText;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mWidthEditText = findViewById(R.id.edt_width);
        mHeightEditText = findViewById(R.id.edt_height);
    ...
    private void startScreenRecorder(final int resultCode, final Intent data) {
        ...
        intent.putExtra(ScreenRecorderService.EXTRA_VIDEO_CONFIG, new VideoConfig(
                Integer.parseInt(mWidthEditText.getText()),
    ...
    private void updateRecording(final boolean isRecording, final boolean isPausing) {
        ...
        try {
            ...
            mWidthEditText.setEditable(!isRecording);
            mHeightEditText.setEditable(!isRecording);
            mFPSEditText.setEditable(!isRecording);
            mIFrameIntervalEditText.setEditable(!isRecording);
            mBitsEditText.setEditable(!isRecording);
        } finally {
            mRecordButton.setOnCheckedChangeListener(mOnCheckedChangeListener);
